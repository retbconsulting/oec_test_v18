...
class PortalWizardUser(models.TransientModel):
    ...
    def action_apply(self):
        ...
        for wizard_user in self.sudo().with_context(active_test=False):
            ...
            group_stagiare = self.env.ref('internship_management_module.group_internship')
            ...
            if wizard_user.in_portal:
                ...
                if not wizard_user.user_id.active or group_portal not in wizard_user.user_id.groups_id:
                    wizard_user.user_id.write({'active': True, 'groups_id': [(4, group_portal.id),(4, group_stagiare.id)]})
